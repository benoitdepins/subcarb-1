...
- **Systematic sampling** of subsurface environments to investigate carbon fixation strategies via metagenomic and metaproteomic analyses.
- **Microbial culture experiments** to explore metabolic versatility under varying environmental conditions.
- **Metabolic modeling** integrating our experimental data to predict carbon fixation fluxes
